  ...
  return (
    <div className="min-h-screen bg-[--site-bg]">
      <Helmet>
        ...
        <meta name="keywords" content="accessories, jewelry, luxury, rings, necklaces, bracelets, earrings, fine jewelry, fashion accessories, handcrafted jewelry, ETHNIC DECO, refined accessories, luxury jewelry" />
